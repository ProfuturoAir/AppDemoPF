...
public class ReporteClientes extends Fragment implements  Spinner.OnItemSelectedListener{
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView) rootView.findViewById(R.id.ggfrc_rv_lista);
    ...
    private void variables(){
        spinnerId = (Spinner) rootView.findViewById(R.id.ggfrc_spinner_id);
        spinnerGerencias = (Spinner) rootView.findViewById(R.id.ggfrc_spinner_gerencia);
        spinnerSucursales = (Spinner) rootView.findViewById(R.id.ggfrc_spinner_sucursal);
        spinnerIdRetenido = (Spinner) rootView.findViewById(R.id.ggfrc_spinner_estado);
        spinnerIdCita = (Spinner) rootView.findViewById(R.id.ggfrc_spinner_citas);
        tvFecha = (TextView) rootView.findViewById(R.id.ggfrc_tv_fecha);
        tvRangoFecha1  = (TextView) rootView.findViewById(R.id.ggfrc_tv_fecha_rango1);
        tvRangoFecha2  = (TextView) rootView.findViewById(R.id.ggfrc_tv_fecha_rango2);
        btnBuscar = (Button) rootView.findViewById(R.id.ggfrc_btn_buscar);
