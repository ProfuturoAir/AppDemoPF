...
public class GerenteReporteAsistenciaAdapter extends RecyclerView.Adapter {
    ...
    public GerenteReporteAsistenciaAdapter(Context mContext, List<GerenteReporteAsistenciaModel> list, RecyclerView mRecyclerView){
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(View view){
            super(view);
            campoLetra = (TextView) view.findViewById(R.id.gfrasl_tv_letra);
            campoNombreAsesor = (TextView) view.findViewById(R.id.gfrasl_tv_nombre_asesor);
            campoNumeroCuentaAsesor = (TextView) view.findViewById(R.id.gfrasl_tv_numero_empleado_asesor);
            campoSucursalAsesor = (TextView) view.findViewById(R.id.gfrasl_tv_numero_sucursal_asesor);
            btn = (Button) view.findViewById(R.id.gfrasl_btn_detalles);
            cardView = (CardView) view.findViewById(R.id.gfrasl_cv);
        }
    }
}
