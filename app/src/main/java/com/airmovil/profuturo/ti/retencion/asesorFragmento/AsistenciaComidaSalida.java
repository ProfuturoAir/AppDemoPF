 ...
 * {@link AsistenciaComidaSalida.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link AsistenciaComidaSalida#newInstance} factory method to
...
public class AsistenciaComidaSalida extends Fragment {
     ...
     * @return A new instance of fragment AsistenciaComidaSalida.
     */
    // TODO: Rename and change types and number of parameters
    public static AsistenciaComidaSalida newInstance(String param1, String param2) {
        AsistenciaComidaSalida fragment = new AsistenciaComidaSalida();
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        Button btnLimpiar = (Button) view.findViewById(R.id.afacs_btn_limpiar);
        Button btnGuardar = (Button) view.findViewById(R.id.afacs_btn_guardar);
        Button btnCancelar= (Button) view.findViewById(R.id.afacs_btn_cancelar);

        lblLatitud = (TextView) view.findViewById(R.id.afacs_lbl_Latitud);
        lblLongitud = (TextView) view.findViewById(R.id.afacs_lbl_Longitud);
        btnActualizar = (ToggleButton) view.findViewById(R.id.afacs_btn_actualizar);

        dvFirma = (DrawingView) view.findViewById(R.id.afacs_dv_firma);
        dvFirma.setBrushSize(5);
        dvFirma.setColor("#000000");
        dvFirma.setFocusable(true);

        //final SignatureView signatureView = (SignatureView) view.findViewById(R.id.afacs_signature_view);
