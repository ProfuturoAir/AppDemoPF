...
public class DirectorReporteAsesoresAdapter extends RecyclerView.Adapter{
    private final int VIEW_TYPE_ITEM = 0;
    private final int VIEW_TYPE_LOADING = 1;
    private Context mContext;
    private List<DirectorReporteAsesoresModel> list;
     ...
     */
    public DirectorReporteAsesoresAdapter(Context mContext, List<DirectorReporteAsesoresModel> list, RecyclerView mRecyclerView,String mFechaInicio,String mFechaFin) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if(viewType == VIEW_TYPE_ITEM){
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.director_fragmento_reporte_asesores_lista, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if(holder instanceof MyViewHolder){
            final DirectorReporteAsesoresModel lista = list.get(position);
     ...
     */
    private void surgirMenu(View view,DirectorReporteAsesoresModel lista) {
    ...
    class MyMenuItemClickListener implements PopupMenu.OnMenuItemClickListener {
        DirectorReporteAsesoresModel lista;

        public MyMenuItemClickListener(DirectorReporteAsesoresModel lista) {
            this.lista = lista;
        }
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(View view){
            super(view);
            campoLetra = (TextView) view.findViewById(R.id.dfral_tv_letra);
            campoIdAsesor = (TextView) view.findViewById(R.id.dfral_tv_id_asesor);
            campoConCita = (TextView) view.findViewById(R.id.dfral_tv_con_cita);
            campoSinCita = (TextView) view.findViewById(R.id.dfral_tv_sin_cita);
            campoEmitidas = (TextView) view.findViewById(R.id.dfral_tv_emitidas);
